        ...
        for ie2 in range(0, ne2):
            ...
            for g1 in range(0, k1):
                for g2 in range(0, k2):
                    ...
                    rho  = (2.+sin(3.*pi*sqrt((x-0.6)**2+(y-0.6)**2)) )#0.8
        ...
        for ie2 in range(0, ne2):
            ...
            for g1 in range(0, k1):
                for g2 in range(0, k2):
                    ...
                    rho  = Crho/(2.+sin(3.*pi*sqrt((x-0.6)**2+(y-0.6)**2)) )#0.8
                    #rho = 3.553841799466826/(1.+ 9./(1.+(10.*sqrt((x-0.7-0.25*0.)**2+(y-0.5)**2)*cos(arctan2(y-0.5,x-0.7-0.25*0.) -20.*((x-0.7-0.25*0.)**2+(y-0.5)**2)))**2) )
